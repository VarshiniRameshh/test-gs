...
1. Users raise Jira tickets to get access through DACT-lite for developer access.
...
5. Work with RBAC Slang Security Sync team to set security sync for the application.
